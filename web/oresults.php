...
<head>
<title>Origin Search Results</title>
<link rel="stylesheet" type="text/css" href="rrstyle.css">
</head>

<body>
<h1>Origin Search Results</h1>
<?php 
        ...
        $query = "SELECT * FROM public.user u, public.pickup p, public.destination d, public.cost c WHERE u.user_id = p.user_id AND u.user_id = d.user_id AND u.user_id = c.user_id AND p.pickup_location ='" . $_POST['plocation'] . "'";
