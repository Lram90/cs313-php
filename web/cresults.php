...
<?php 
        ...
        $query = "SELECT * FROM public.user u, public.pickup p, public.destination d, public.cost c WHERE u.user_id = p.user_id AND u.user_id = d.user_id AND u.user_id = c.user_id AND c.user_name ='" . $_POST['customer'] . "'";
